...
### prep count
filtNorm_dt <- get(load(file.path("../../../ovarian_project/phenopath/PHENOPATH_RECOUNT2_TCGA_BRCA_LUMALUMB//brca_data_gcNorm.Rdata")))
# Kaspar advice
...
write.table(log_filtNormCount_mostVar, file = "log_filtNormCount_mostVar_dt.txt", sep=",", 
...
########## out annotation
tcga_annot_dt_out <- tcga_annot_dt[,c("cgc_sample_id", "PAM50")]
