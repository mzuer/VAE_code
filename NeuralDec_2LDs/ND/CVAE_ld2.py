...
#                      int_cz1z2_dc, int_cz1z2_dz1, int_cz1z2_dz2
        ...
        int_z1z2_dz2, int_cz1z2_dc, int_cz1z2_dz1, int_cz1z2_dz2 = self.decoder.loss(y_pred, Y)
        ...
        int_cz1_dc, int_cz1_dz1,\
        int_cz2_dc, int_cz2_dz2, int_z1z2_dz1,\
        int_z1z2_dz2, int_cz1z2_dc, int_cz1z2_dz1, int_cz1z2_dz2
    ...
    def optimize(self, data_loader, augmented_lagrangian_lr, n_iter=50000, 
        ...
        _int_cz1, _int_cz2, _int_z1z2, _int_cz1z2 = self.decoder.calculate_integrals_numpy()
        ...
        int_cz1z2_values = np.zeros([n_logging_steps, _int_cz1z2.shape[0], self.output_dim])
        ...
        int_cz1_dc, int_cz1_dz1,\
        int_cz2_dc, int_cz2_dz2, int_z1z2_dz1,\
        int_z1z2_dz2, int_cz1z2_dc, int_cz1z2_dz1, int_cz1z2_dz2 = self.forward(data_subset, beta=1.0, device=self.device)
...
#### how to do with the 3 terms here ?????????????????????????
                    self.decoder.Lambda_cz1z2_c += augmented_lagrangian_lr * int_cz1z2_dz2##### ???? what here ???              
                    self.decoder.Lambda_cz1z2_z1 += augmented_lagrangian_lr * int_cz1z2_dz1
                    self.decoder.Lambda_cz1z2_z2 += augmented_lagrangian_lr * int_cz1z2_dc                    
...
# init version:
 ...
 #f.Lambda_cz_2 = Variable(lambda0*torch.ones(self.n_grid_c,  * * int_cz_dz
                ...
                if iteration % logging_freq_int == 0:
                    #         return int_z1, int_z2, int_c, int_cz1, int_cz2, int_z1z2, int_cz1z2
                    int_z1, int_z2, int_c,\
                    int_cz1, int_cz2, int_z1z2, int_cz1z2 = self.decoder.calculate_integrals_numpy()
        ...
        integrals = np.hstack([int_z1_values, int_z2_values, int_c_values,\
                               int_cz1_values, int_cz2_values,int_z1z2_values, int_cz1z2_values ]).\
...
class CVAE_with_fixed_z(CVAE):
    ...
    def forward(self, data_subset, beta=1.0):
        ...
        decoder_loss, penalty, int_z1, int_z2, int_c, int_cz1_dc, int_cz1_dz1,\
                     int_cz2_dc, int_cz2_dz2, int_z1z2_dz1, int_z1z2_dz2,\
                     int_cz1z2_dc, int_cz1z2_dz1, int_cz1z2_dz2 = self.decoder.loss(y_pred, Y)
